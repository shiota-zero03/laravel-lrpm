            ...
            <div class="card">
                <div class="card-body pt-4">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('fakultas.monev.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('fakultas.monev.show', ['type' => $type, 'submission_code' => $data->submission_code]) }}" class="btn btn-primary">Lihat detail monev</a>
                    </div>
                    <div class="timeline">
