...
@section('page', 'Tracking Laporan Final')
            ...
            <div class="card">
                <div class="card-body pt-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('fakultas.laporan-final.show', ['type' => $type, 'submission_code' => $data->submission_code]) }}" class="btn btn-primary">Lihat detail laporan final</a>
                    </div>
                    <div class="timeline">
