...
@section('page', 'Tracking Publikasi')
            ...
            <div class="card">
                <div class="card-body pt-4">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('fakultas.publikasi.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('fakultas.publikasi.show', ['type' => $type, 'submission_code' => $data->submission_code]) }}" class="btn btn-primary">Lihat detail publikasi</a>
                    </div>
                    <div class="timeline">
