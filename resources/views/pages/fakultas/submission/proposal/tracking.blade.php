...
@section('page', 'Tracking Proposal')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('fakultas.proposal.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('fakultas.proposal.show', ['type' => $type, 'submission_code' => $data->submission_code]) }}" class="btn btn-primary">Lihat detail proposal</a>
                    </div>
                    <div class="timeline">
