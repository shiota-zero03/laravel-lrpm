...
<div>
    ...
    <form  action="{{ route('dosen.publikasi.submit', ['type' => $type, 'submission_code' => $check_code->submission_code]) }}" method="post">
        @csrf
        <div class="d-md-flex">
            <a href="?page=2" class="btn btn-secondary me-2 mb-2"><small>Sebelumnya</small></a>
            <a href="{{ route('admin.publikasi.index', $type) }}" class="btn btn-warning text-white me-2 mb-2"><small>Draft</small></a>
