            ...
            <div class="card">
                <div class="card-body pt-4">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('dosen.publikasi.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('dosen.publikasi.detail', ['type' => $type, 'id' => $data->id]) }}" class="btn btn-primary">Lihat detail publikasi</a>
                    </div>
                    <div class="timeline">
