...
@section('breadcrumb', 'Laporan Final')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mt-3">
                        <a href="{{ route('dosen.laporan-final.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('dosen.laporan-final.show', ['type' => $type, 'id' => $check_code->id]) }}" class="btn btn-primary">Lihat traking</a>
                    </div>
                    <div>
                        ...
                        @if ( $check_code->status_laporan_final == 'Approved' || $check_code->status_laporan_final == 'Rejected by Reviewer' || $check_code->status_laporan_akhir == 'Returned by Reviewer' )
