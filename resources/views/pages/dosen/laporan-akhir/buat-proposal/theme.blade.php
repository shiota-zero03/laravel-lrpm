...
@section('breadcrumbs_sub_page', 'Laporan Akhir')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="card-title">Pengajuan Laporan Akhir</h5>
