            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mt-3">
                        ...
                        <a href="{{ route('dosen.proposal.show', ['type' => $type, 'id' => $check_code->id]) }}" class="btn btn-primary">Lihat traking</a>
                    </div>
                    <div>
                        ...
                        @if($check_code->spk_download)
                            <h6 class="card-title my-0">8. SPK :</h6>
                            <div class="row">
                                <div class="col-12 mb-2">
                                    <label for="file-usulan" class="fw-bold mb-1">File Usulan :</label><br />
                                    <a href="{{ asset('assets/storage/files/spk-download/'.$check_code->spk_download) }}" class="btn btn-success w-100" id="file-usulan">
