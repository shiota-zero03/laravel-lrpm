            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between pt-4">
                        <a href="{{ route('admin.laporan-akhir.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('admin.laporan-akhir.tracking', ['type' => $type, 'id' => $check_code->id]) }}" class="btn btn-primary">Lihat traking</a>
                    </div>
                    <div>
                        ...
                        @endif
                        @if($check_code->status_laporan_akhir == 'Pending by Admin')
                            <div class="d-md-flex">
                        ...
                        @endif
                        @if($check_code->status_laporan_akhir == 'Waiting for Validation')
                            <div class="d-md-flex">
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response){
                                            ...
                                            Swal.fire({
                                                ...
                                                document.location.href="{{ route('admin.laporan-akhir.index', $check_code->tipe_submission) }}"
                                            });
                                        },
