            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between pt-4">
                        <a href="{{ route('admin.publikasi.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('admin.publikasi.tracking', ['type' => $type, 'id' => $check_code->id]) }}" class="btn btn-primary">Lihat traking</a>
                    </div>
                    <div>
                        ...
                        @if($check_code->status_publikasi == 'Pending by Admin')
                            <div class="d-md-flex">
                                <button type="button" onclick="action('menyetujui')" class="btn btn-primary text-white me-2 mb-2"><small>Setujui data publikasi</small></button>
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response){
                                            ...
                                            Swal.fire({
                                                ...
                                                document.location.href="{{ route('admin.publikasi.index', $check_code->tipe_submission) }}"
                                            });
                                        },
