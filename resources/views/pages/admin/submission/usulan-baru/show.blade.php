            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between pt-4">
                        <a href="{{ route('admin.usulan-baru.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                        <a href="{{ route('admin.usulan-baru.tracking', ['type' => $type, 'id' => $check_code->id]) }}" class="btn btn-primary">Lihat traking</a>
                    </div>
                    <div>
                        ...
                        @if($check_code->status_usulan == 'Pending by Admin')
                            ...
                            <div class="d-md-flex">
                                <button type="button" onclick="action('menyetujui')" class="btn btn-primary text-white me-2 mb-2"><small>Lanjutkan ke Program Studi</small></button>
                        ...
                        @endif
                        @if($check_code->status_usulan == 'Waiting for Validation')
                            <div class="d-md-flex">
