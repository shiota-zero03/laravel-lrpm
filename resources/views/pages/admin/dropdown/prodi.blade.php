...
@section('page', 'Dropdown Program Studi')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><strong>Data Program Studi</strong></h5>
            ...
            <div class="modal-body">
                <form id="form">
                    ...
                    <div class="form-group mb-2">
                        <label class="form-control-label" for="nama">Nama Program Studi <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select name="fakultas" id="fakultas" class="form-control">
                            ...
                            @foreach($fakultas as $fac)
                                <option value="{{ $fac->id }}">{{ $fac->nama_fakultas }}</option>
                            @endforeach
                        </select>
...
<script src="{{ asset('assets/js/pages/prodi.js') }}"></script>
