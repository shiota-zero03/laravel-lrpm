...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Daftar Tema</h5>
                    <button type="button" onclick="openModal(0)" class="btn btn-primary rounded mb-3">
                        <i class="bi bi-plus"></i> Tambah Tema
                    </button>
                    <div class="table-responsive">
                        <table class="table" id="tema-datatable">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><strong>Data Tema</strong></h5>
            ...
            <div class="modal-body">
                <form id="form">
                    ...
                    <div class="form-group mb-2">
                        <label class="form-control-label" for="nama">Nama Tema <span class="text-danger">*</span></label>
...
<script src="{{ asset('assets/js/pages/tema.js') }}"></script>
