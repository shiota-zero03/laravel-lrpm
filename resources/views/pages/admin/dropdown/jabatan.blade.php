    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><strong>Data Jabatan</strong></h5>
            ...
            <div class="modal-body">
                <form id="form">
                    ...
                    <div class="form-group mb-2">
                        <label class="form-control-label" for="nama">Nama Jabatan <span class="text-danger">*</span></label>
                        <input class="form-control" id="nama" name="nama" type="text">
                        <small class="text-danger fst-italic" id="error_nama"></small>
                    </div>
                    <div class="form-group mb-2">
                        <label class="form-control-label" for="role">Kebutuhan Untuk Role <span class="text-danger">*</span></label>
                        ...
                        <small class="text-danger fst-italic" id="error_role"></small>
                    </div>
                </form>
            </div>
