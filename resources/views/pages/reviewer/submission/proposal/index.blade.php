                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif( $usulan->status_proposal == 'Rejected by Admin' || $usulan->status_proposal == 'Rejected by Reviewer' )
                                                ...
                                                <small>
                                                    Alasan ditolak: <b>{{ $usulan->status_proposal_ditolak }}</b>
                                                </small>
                                            ...
                                            @else
                                                ...
                                                @if( $usulan->status_proposal == 'Returned by Admin' || $usulan->status_proposal == 'Returned by Reviewer' )
                                                    <small>
                                                        Alasan dikembalikan: <b>{{ $usulan->status_proposal_ditolak }}</b>
                                                    </small>
                                                @endif
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{route('reviewer.proposal.show', ['type' => $usulan->tipe_submission, 'submission_code' => $usulan->submission_code])}}" class="btn text-white btn-primary mb-1 me-1 btn-sm"><strong><i class="bi bi-eye"></i></strong></a>
                                            <a href="{{route('reviewer.proposal.tracking', ['type' => $usulan->tipe_submission, 'id' => $usulan->id])}}" class="btn btn-info text-white mb-1 me-1 btn-sm"><i class="bi bi-search"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
