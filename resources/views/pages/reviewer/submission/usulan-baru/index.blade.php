                            ...
                            <tbody>
                                ...
                                @foreach( $data as $usulan )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('reviewer.usulan-baru.show', ['type' => $usulan->tipe_submission, 'submission_code' => $usulan->submission_code])}}" class="btn btn-primary mb-1 me-1 btn-sm"><strong><i class="bi bi-eye"></i></strong></a>
                                            <a href="{{route('reviewer.usulan-baru.tracking', ['type' => $usulan->tipe_submission, 'id' => $usulan->id])}}" class="btn btn-secondary">Tracking</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
