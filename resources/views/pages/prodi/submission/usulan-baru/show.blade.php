                ...
                <div class="card-body">
                    <div>
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('prodi.usulan-baru.index', ['type' => $type]) }}" class="btn btn-info text-white"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
                            <a href="{{ route('prodi.usulan-baru.tracking', ['type' => $type, 'id' => $check_code->id]) }}" class="btn btn-primary">Lihat traking</a>
                        </div>
                        ...
                        @if($check_code->status_usulan == 'Pending by Prodi')
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response){
                                            Swal.fire({
                                                ...
                                                document.location.href="{{ route('prodi.usulan-baru.index', $check_code->tipe_submission) }}"
                                            });
                                        },
