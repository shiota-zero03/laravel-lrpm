...
class UsulanBaruController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = Submission::where('tipe_submission', $type)
                            ...
                            ->orderByDesc('id')
                            ->get();
        return view('pages.reviewer.submission.usulan-baru.index', compact(['type', 'data']));
    }
    public function tracking(Request $request){
        ...
        return view('pages.reviewer.submission.usulan-baru.tracking', compact(['type', 'data', 'timeline']));
    }
    public function show(Request $request)
    {
        ...
        return view('pages.reviewer.submission.usulan-baru.show', compact(['type', 'check_code', 'user']));
    }
}
