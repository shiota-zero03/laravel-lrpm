...
class UsulanBaruController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')
                            ...
                            ->get();
        return view('pages.prodi.submission.usulan-baru.index', compact(['type', 'data']));
    }
    public function tracking(Request $request){
        ...
        return view('pages.prodi.submission.usulan-baru.tracking', compact(['type', 'data', 'timeline']));
    }
    public function show(Request $request)
    {
        ...
        return view('pages.prodi.submission.usulan-baru.show', compact(['type', 'check_code', 'user']));
    }
    public function action(Request $request)
    {
        ...
        if($request->aksi == 'Rejected') {
            \App\Models\Notification::create([
                ...
                'judul_notifikasi' => 'Informasi penolakan usulan oleh prodi',
                'text_notifikasi' => $request->alasan,
                'to_role' => 5,
            ...
            \App\Models\TimelineProgress::create([
                ...
                'judul_progress' => 'Data ditolak oleh prodi',
            ...
            \App\Models\TimelineProgress::create([
                'id_submission' => $check_code->id,
                'judul_progress' => 'Data dikembalikan oleh prodi',
                'text_progress' => $request->alasan,
            ...
            \App\Models\Notification::create([
                ...
                'text_notifikasi' => 'Usulan diterima oleh prodi, silahkan upload proposal',
                'to_role' => 5,
                'to_id' => $check_code->id_pengaju,
                'read_status' => 'unread',
            ]);
            ...
            \App\Models\TimelineProgress::create([
                'id_submission' => $check_code->id,
                'judul_progress' => 'Usulan baru diterima oleh prodi',
                'text_progress' => 'Usulan diterima, ssilahkan lanjutkan ke data proposal',
