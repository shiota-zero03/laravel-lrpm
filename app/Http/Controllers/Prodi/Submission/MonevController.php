...
class MonevController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')
                            ...
                            ->get();
        return view('pages.prodi.submission.monev.index', compact(['type', 'data']));
    }
    public function tracking(Request $request)
    {
        ...
        return view('pages.prodi.submission.monev.tracking', compact(['type', 'data', 'timeline']));
    }
    public function show(Request $request)
    {
        ...
        return view('pages.prodi.submission.monev.show', compact(['type', 'check_code', 'user', 'nilai']));
    }
