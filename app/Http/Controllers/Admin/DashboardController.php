...
class DashboardController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        $univPenelitian = [
            ...
            'upload_proposal' => Submission::where('tipe_submission', 'penelitian')->whereNot('status_proposal', null)->whereNot('status_akhir', null)->get()->count(),
            'proposal_diterima' => Submission::where('tipe_submission', 'penelitian')->whereNot('status_proposal', 'Approved')->whereNot('status_akhir', null)->get()->count(),

            'upload_laporan_akhir' => Submission::where('tipe_submission', 'penelitian')->whereNot('status_laporan_akhir', null)->whereNot('status_akhir', null)->get()->count(),
            ...
            'upload_laporan_final' => Submission::where('tipe_submission', 'penelitian')->whereNot('status_laporan_final', null)->whereNot('status_akhir', null)->get()->count(),
        ...
        $univPkm = [
            ...
            'upload_proposal' => Submission::where('tipe_submission', 'pengabdian-masyarakat')->whereNot('status_proposal', null)->whereNot('status_akhir', null)->get()->count(),
            'proposal_diterima' => Submission::where('tipe_submission', 'pengabdian-masyarakat')->whereNot('status_proposal', 'Approved')->whereNot('status_akhir', null)->get()->count(),

            'upload_laporan_akhir' => Submission::where('tipe_submission', 'pengabdian-masyarakat')->whereNot('status_laporan_akhir', null)->whereNot('status_akhir', null)->get()->count(),
            ...
            'upload_laporan_final' => Submission::where('tipe_submission', 'pengabdian-masyarakat')->whereNot('status_laporan_final', null)->whereNot('status_akhir', null)->get()->count(),
        ...
        $fbisPenelitian = [
            ...
            'upload_proposal' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_proposal', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),
            'proposal_diterima' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_proposal', 'Approved')->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),

            'upload_laporan_akhir' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_laporan_akhir', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),
            ...
            'upload_laporan_final' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_laporan_final', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),
        ...
        $ftiPenelitian = [
            ...
            'upload_proposal' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_proposal', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),
            'proposal_diterima' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_proposal', 'Approved')->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),

            'upload_laporan_akhir' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_laporan_akhir', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),
            ...
            'upload_laporan_final' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_laporan_final', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'penelitian')->get()->count(),
        ...
        $fbisPkm = [
            ...
            'upload_proposal' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_proposal', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),
            'proposal_diterima' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_proposal', 'Approved')->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),

            'upload_laporan_akhir' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_laporan_akhir', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),
            ...
            'upload_laporan_final' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 2)->whereNot('submissions.status_laporan_final', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),
        ...
        $ftiPkm = [
            ...
            'upload_proposal' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_proposal', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),
            'proposal_diterima' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_proposal', 'Approved')->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),

            'upload_laporan_akhir' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_laporan_akhir', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),
            ...
            'upload_laporan_final' => Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')->join('faculties', 'users.fakultas', '=', 'faculties.id')->where('faculties.id', 1)->whereNot('submissions.status_laporan_final', null)->whereNot('submissions.status_akhir', null)->where('submissions.tipe_submission', 'pengabdian-masyarakat')->get()->count(),
