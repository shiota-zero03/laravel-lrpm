...
class PublikasiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = Submission::join('users', 'users.id', '=', 'submissions.id_pengaju')
                            ...
                            ->get();
        return view('pages.fakultas.submission.publikasi.index', compact(['type', 'data']));
    }
    public function tracking(Request $request){
        ...
        return view('pages.fakultas.submission.publikasi.tracking', compact(['type', 'data', 'timeline']));
    }
    public function show(Request $request)
    {
        ...
        return view('pages.fakultas.submission.publikasi.show', compact(['type', 'check_code', 'user']));
    }
}
